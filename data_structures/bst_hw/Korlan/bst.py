...
class BinarySearchTree:
	...
	def successor(self, x: BinarySearchTreeNode) -> BinarySearchTreeNode:
		...
		else: # the lowest ancestor of x whose left child is an ancestor of x
			y = x.parent
	...
	def predecessor(self, x: BinarySearchTreeNode) -> BinarySearchTreeNode:
		...
		else: # the lowest ancestor of x whose right child is an ancestor of x
			y = x.parent
	...
	def tree_insert_node(self, z: BinarySearchTreeNode):
		...
		x = self.get_root() # node being compared with z
